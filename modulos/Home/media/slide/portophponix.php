					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 670, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }, 'navigation' : {'arrows': { 'enable': true }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li data-transition="fade">
								<img src="<?php echo $page_url.$path_tema;?>img/slides/slide-bg.jpg"  
									alt=""
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="<?php echo $page_url.$path_tema;?>img/slides/slide-devices.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="<?php echo $page_url.$path_tema;?>img/slides/slide-laptop.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme rs-parallaxlevel-7"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="<?php echo $page_url.$path_tema;?>img/slides/slide-parallax-porto-symbol.png" alt=""></div>
								...
								<div class="tp-caption"
									...
									data-transform_idle="opacity:0.2;s:500;"><img src="<?php echo $page_url.$path_tema;?>img/slides/slide-title-border.png" alt=""></div>
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">¿NECESITAS UNA</div>
								...
								<div class="tp-caption d-none d-md-block"
									...
									data-y="center" data-voffset="['-33','-33','-33','-55']"><img src="<?php echo $page_url.$path_tema;?>img/slides/slide-blue-line.png" alt=""></div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-lineheight="['55','55','55','95']">PAGINA WEB?</div>
								...
								<div class="tp-caption font-weight-light"
									...
									style="color: #b5b5b5;"><strong class="text-color-light">PHPONIX-cms</strong> es tu solución</div>

							</li>
							<li class="slide-overlay" data-transition="fade">
								<img src="<?php echo $page_url.$path_tema;?>img/slides/slide-bg-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-lineheight="['25','25','25','45']"
									data-transform_in="y:[-50%];opacity:0;s:500;">ADMINISTRAR TU NEGOCIO</div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-1"
									...
									data-y="center"
									data-fontsize="['50','50','50','90']"
									data-lineheight="['55','55','55','95']">NUNCA FUE TAN FACIL</div>
								...
								<div class="tp-caption font-weight-light ws-normal text-center"
									...
									style="color: #b5b5b5;"><strong class="text-color-light">PHPONIX-cms</strong> la solución completa y moderna, sin complicaciones.</div>

							</li>
							<li class="slide-overlay slide-overlay-primary" data-transition="fade">
								<img src="<?php echo $page_url.$path_tema;?>img/slides/slide-bg-6.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-fontsize="['16','16','16','40']"
									data-lineheight="['25','25','25','45']"
									data-transform_in="y:[-50%];opacity:0;s:500;">CREA TU PAGINA WEB CON</div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-x="center" data-hoffset="['210','210','210','370']"
									data-y="center"
									data-fontsize="['145','145','145','250']"
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-x="center" data-hoffset="['275','275','275','490']"
									data-y="center"
									data-fontsize="['145','145','145','250']"
									data-lineheight="['150','150','150','260']">X</div>
