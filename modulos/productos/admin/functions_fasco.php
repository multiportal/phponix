      ...
      <div class="wrap mcb-wrap one clearfix" style="">
         <div class="mcb-wrap-inner">
            <div class="column mcb-column two-third column_hover_box ">
               <div class="hover_box">
                  <a href="#">
                     <div class="hover_box_wrapper"><img class="visible_photo scale-with-grid" src="'.$page_url.'modulos/productos/fotos/'.$cover.'" alt="'.$producto.'" width="575" height="575"><img class="hidden_photo scale-with-grid" src="'.$page_url.'modulos/productos/fotos/'.$cover.'" alt="'.$producto.'" width="575" height="575"></div>
                  </a>
               </div>
            </div>
            <div class="column mcb-column one-third column_column ">
               <div class="column_attr clearfix" style="">
                  <div style="margin: 0px 5% 0 10px;">
                     ...
                     <div style="text-align:justify">'.$resena.'</div>
					 <p><img src="'.$page_url.'modulos/productos/fotos/pdf_icon.png" width="25"> <span class="al">DESCARGA FICHAS TECNICAS</span></p>
                     <p style="text-align:justify">
					 	<ul style="color: #ff4141;">';
if($pdf!=''){
	echo '<li><a target="_blank" href="'.$page_url.'modulos/productos/pdf/'.$pdf.'" class="link_red">'.$pdf.'</a></li>';
}						
if($pdf2!=''){
	echo '<li><a target="_blank" href="'.$page_url.'modulos/productos/pdf/'.$pdf2.'" class="link_red">'.$pdf2.'</a></li>';
}						
if($pdf3!=''){
	echo '<li><a target="_blank" href="'.$page_url.'modulos/productos/pdf/'.$pdf3.'" class="link_red">'.$pdf3.'</a></li>';
}						
if($pdf4!=''){
	echo '<li><a target="_blank" href="'.$page_url.'modulos/productos/pdf/'.$pdf4.'" class="link_red">'.$pdf4.'</a></li>';
}						
if($pdf5!=''){
	echo '<li><a target="_blank" href="'.$page_url.'modulos/productos/pdf/'.$pdf5.'" class="link_red">'.$pdf5.'</a></li>';
}						
echo '
						</ul>
					 </p>
