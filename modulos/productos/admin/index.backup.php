...
$aceptarpdf1=$_POST['Aceptarpdf1'];
$aceptarpdf2=$_POST['Aceptarpdf2'];
$aceptarpdf3=$_POST['Aceptarpdf3'];
$aceptarpdf4=$_POST['Aceptarpdf4'];
$aceptarpdf5=$_POST['Aceptarpdf5'];

$success=array($aceptar,$aceptar1,$aceptar2,$aceptar3,$aceptar4,$aceptar5);
$success2=array('',$aceptarpdf1,$aceptardpf2,$aceptarpdf3,$aceptarpdf4,$aceptarpdf5);	 
//if($_POST['Aceptar']){
//$ID=$_POST['ID'];
$codigo=$_POST['codigo'];
//$clave=$_POST['clave'];
...
//compruebo si las características del archivo son las que deseo 
	if (!((strpos($tipo_archivo, "gif") || strpos($tipo_archivo, "jpeg") || strpos($tipo_archivo, "png") || strpos($tipo_archivo, "pdf")) && ($tamano_archivo < 1000000))) { 
    	...
    	if (@move_uploaded_file($_FILES['userfile']['tmp_name'],$path_archivo)){
			for($i=0;$i<=5;$i++){
				if($success[$i]!=''){
					if($i==0){$avi='Cambiar';$avi2='';$img_data='<img src="'.$page_url.'modulos/'.$mod.'/fotos/'.$nombre_archivo.'" width="100%"><br>';
						$im='
						<div class="form-group">
							<input type="hidden" class="form-control" id="cover" name="cover" value="'.$nombre_archivo.'">
							<div>
								'.$img_data.'
								<div><a href="javascript:up(1);">'.$avi.' Imagen </a> '.$avi2.'<div id="upload"></div></div> 
							</div>
...
for($i=1;$i<=5;$i++){$ima_src.=$file_ima[$i];$pdf_src.=$file_pdf[$i];}
