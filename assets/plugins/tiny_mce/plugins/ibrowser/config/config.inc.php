<?php
	...
	// Revision: 1.4.1                 Date: 10/18/2009
	...
	$cfg['lang']   		= 'es';														// default language; e.g. 'en'		
...
/*		array (
    ...
    $page = str_ireplace("ibrowser.php","",$page);
    ...
    // image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		...
		array (                                                                        
            ...
            'text'        => 'Fotos del sitio',

        ),

        array (                                                                        

            'value'       => $page.'/pictures/modulos/',                                                

            'text'        => 'Fotos de Modulos',

        ),

        array (                                                                        

            'value'       => $page.'/pictures/noticias/',                                                

            'text'        => 'Fotos de Noticias',

        ),

    );

    @chmod($page.'/pictures/',0755);

    @chmod($page.'/pictures/noticias/',0755);

    @chmod($page.'/pictures/modulos/',0755);
	...
	$cfg['ilibs_dir']        = array($page.'/pictures/',$page.'/pictures/modulos/',$page.'/pictures/noticias/');                               
	...
	$cfg['ver'] 		= '1.4.1 - build 10182009';										// iBrowser version	
